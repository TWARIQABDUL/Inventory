...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> _submit() async {
    ...
    if (ok) {
      ...
      Get.snackbar('Error', 'Invalid email or password', snackPosition: SnackPosition.BOTTOM, backgroundColor: AppTheme.errorColor, colorText: Colors.white);
    }
  }
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                Center(child: Icon(Icons.shopping_cart, size: 72, color: AppTheme.primaryColor)),
